...
//import com.augmentedsoftware.compass.R;
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
    	synchronized (this) {
    		if (sensorEvent.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
    			...
    			/*
    			accelXValue.setText(Integer.toString((int)sensorEvent.values[0]));
    			accelYValue.setText(Integer.toString((int)sensorEvent.values[1]));
    			accelZValue.setText(Integer.toString((int)sensorEvent.values[2]));  
    			*/
    		}
